...
public:
  ...
  inline void set_vehicle_interface(QString vehicle_interface) {
    ...
    if (this->vehicle_interface == "disabled")
      ...
      this->settings.setValue("Pages/Vehicle/interface",
  ...
  inline const QString &get_cam_local_device() {
    return this->cam_local_device;
  }
  inline void set_cam_local_device(QString local_device) {
    this->cam_local_device = local_device;
    this->settings.setValue("Pages/Camera/local_device",
  ...
  inline QVideoFrameFormat::PixelFormat get_cam_local_format_override() {
    return this->cam_local_format_override;
  }
  inline void
  set_cam_local_format_override(QVideoFrameFormat::PixelFormat local_format) {
    this->cam_local_format_override = local_format;
    this->settings.setValue("Pages/Camera/local_format_override",
  ...
  inline void set_cam_autoconnect(bool enabled) {
    ...
    this->settings.setValue("Pages/Camera/automatically_reconnect",
                            this->cam_autoconnect);
  }

  inline int get_cam_autoconnect_time_secs() {
    return this->cam_autoconnect_time_secs;
  }
  inline void set_cam_autoconnect_time_secs(int seconds) {
    this->cam_autoconnect_time_secs = seconds;
    this->settings.setValue("Pages/Camera/auto_reconnect_time_secs",
  ...
  inline void set_cam_overlay_width(int value) {
    ...
    this->settings.setValue("Pages/Camera/Overlay/width",
  ...
  inline void set_cam_overlay_height(int value) {
    ...
    this->settings.setValue("Pages/Camera/Overlay/height",
  ...
  inline void set_show_aa_connected(bool enabled) {
    ...
    this->settings.setValue("Pages/OpenAuto/show_aa_connected",
                            this->show_aa_connected);
  }

  inline const QStringList &get_launcher_plugins() {
    return this->launcher_plugins;
  }
  inline void set_launcher_plugin(QString plugin, bool remove = false) {
    ...
    for (int i = 0; i < this->launcher_plugins.size(); i++)
      this->settings.setValue(QString("Pages/Launcher/%1").arg(i),
                              this->launcher_plugins[i]);
  }
...
private:
  ...
  bool cam_is_network;
  QVideoFrameFormat::PixelFormat cam_local_format_override;
