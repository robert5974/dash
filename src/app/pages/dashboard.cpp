...
{
    auto layout = new QHBoxLayout(this->container_->widget);
    ...
    nav_icon->setPixmap(QIcon(":/icons/directions_car.svg").pixmap(64, 64)); // Placeholder size, styling handled in QSS if possible or here
    ...
    media_icon->setPixmap(QIcon(":/icons/play_circle_outline.svg").pixmap(64, 64));
    ...
    phone_icon->setPixmap(QIcon(":/icons/call.svg").pixmap(64, 64)); // Assuming call.svg exists or use similar
